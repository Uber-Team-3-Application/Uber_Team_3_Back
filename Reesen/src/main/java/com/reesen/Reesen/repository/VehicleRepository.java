...
public interface VehicleRepository extends JpaRepository<Vehicle, Long> {
    ...
    @Query("select new com.reesen.Reesen.dto.VehicleLocationWithAvailabilityDTO(v.id, dr.isActive, v.currentLocation.address, v.currentLocation.latitude, v.currentLocation.longitude) from Vehicle v inner join v.driver dr where dr.vehicle.id = v.id and dr.isActive = true")
    ...
    Vehicle findVehicleByDriverId(Long driverId);
}
