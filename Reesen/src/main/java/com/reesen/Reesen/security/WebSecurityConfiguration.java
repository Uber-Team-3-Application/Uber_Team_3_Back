    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.headers().frameOptions().disable();
                ...
                .authorizeRequests()
                         ...
                         .antMatchers(HttpMethod.GET,"/api/passenger/activate/{activationId}").permitAll()
                         .antMatchers(HttpMethod.GET,"/api/passenger/activate/account").permitAll()
                         .antMatchers(HttpMethod.POST,"/api/user/mail").permitAll()
